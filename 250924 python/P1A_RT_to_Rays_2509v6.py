...
class DataIO:
    ...
    def save_rays_unified(ray_arrays, area_index, freq_ghz, rx_index):
        ...
        if p1a_config.ENABLE_RAY_SAVING:
            ...
            # Save basic ray arrays with optimized naming (float32 optimization for P2 compatibility)
            for key in ['tau', 'power', 'theta_r', 'theta_t', 'phi_r', 'phi_t', 'counts']:
                ...
                # Enhancement: Force float32 for P2 compatibility and memory efficiency
                if p1a_config.FORCE_FLOAT32_SAVING and key != 'counts':
            ...
            for param in ray_params:
                ...
                for rx_idx in rx_indices:
                    if param in all_ray_data[rx_idx]:
                        ...
                        if p1a_config.FORCE_FLOAT32_SAVING and param != 'counts':
