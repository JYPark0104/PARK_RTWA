...
class PathRT:
    ...
    def extract_cir(paths):
        ...
        # normalize_delays=False: 절대 전파지연(ToA) 보존을 위해 True->False 변경
        #   (2026-06-06) 기존 True는 첫 도착=0(excess delay)이라 LoS 거리정보 소실.
        #   False면 tau[LoS]=거리/c -> 단일/multi-BS ToA 측위 가능. (그 외 로직 동일)
